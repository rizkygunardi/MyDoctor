...
const Chatting = ({navigation, route}) => {
  ...
  const chatSend = () => {
    ...
    //untuk setting chatting
    const urlFirebase = `chatting/${chatID}/allChat/${setDateChat(today)}`;

    //untuk Message Histori user
    const urlMessageUser = `messages/${user.uid}/${chatID}`;

    //untuk Message Histori doctor
    const urlMessageDoctor = `messages/${dataDoctor.data.uid}/${chatID}`;

    //untuk Data Histori Chat
    ...
    Firebase.database()
      ...
      .then(() => {
        setChatContent(' ');
        //untuk menyimpan chatting histori ke database untuk user
        Firebase.database().ref(urlMessageUser).set(dataHistoryChatForUser);

        //untuk menyimpan chatting histori ke database untuk dokter
